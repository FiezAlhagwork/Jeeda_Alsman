...
export default function ProcessStepCard({
  ...
  return (
    <div className="step-card group relative shrink-0 w-full md:w-[min(100vw-5rem,28rem)] p-8 rounded-3xl bg-[#111111] border-t border-[#1F2937] hover:border-white/20 transition-colors duration-300">
      <div className="mb-6">
